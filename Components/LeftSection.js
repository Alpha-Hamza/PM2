    ...
    return (
      <div className="bg-[#1F2937]  mt-[12px] pt-[24px] pb-[12.95%]  rounded-r-[12px] w-[100%]   2xl:ml-0 sm:ml-[5%]   ">
         <div className="  flex-col border-b-[1px] border-[#374151] sm:w-auto  w-[58px]   ">
             ...
             <img src="./Images/Li.svg" alt=" " className="xl:ml-[32px] sm:ml-[15px] sm:mx-0 mx-auto  " />
             <button className="text-[#9CA3AF] ml-[8px] sm:block hidden ">Home</button>

             </div>
             <div className="flex mt-[5px] hover:bg-[#0284C7] w-full h-[48px]  items-center rounded-[12px]">
             <img src="./Images/Li11.svg" alt=" " className="xl:ml-[32px] sm:ml-[15px] sm:mx-0 mx-auto  " />
             <button className="text-[#9CA3AF] ml-[8px] sm:block hidden  ">Explore</button>

             </div>
             <div className="bg-[#0284C7] rounded-[12px] w-full h-[48px] flex justify-start items-center mt-[5px] mb-[12px]">
             <img src="./Images/Li3.svg" alt=" " className="xl:ml-[32px] sm:ml-[15px] sm:mx-0 mx-auto" />
             <button className="text-[#F9FAFB] ml-[8px] sm:block hidden ">Leaderboard</button>
      ...
      <div className="flex mt-[24px] ">
             <img src="./Images/Li4.svg" alt=" " className="xl:ml-[32px] sm:ml-[15px] sm:mx-0 mx-auto" />
             <h1 className="text-[#FFFFFF] ml-[8px] font-semibold sm:block hidden ">Portfolio Overview</h1>

             </div>
             <div className="xl:ml-[32px] sm:ml-[15px] sm:mx-0 mx-auto mt-[16px]">
             <h1 className="text-[#9CA3AF]  text-[12px]  font-semibold sm:block hidden ">Value</h1>
      ...
      <div className="flex  ">
             <img src="./Images/Li5.svg" alt=" " className=" sm:mx-0 mx-auto" />
             <h1 className="text-[#FFFFFF] ml-[8px] font-semibold sm:block hidden ">Following</h1>

             </div>
             <div className="mt-[25px]">
             <h1 className="text-[#9CA3AF]  font-semibold text-[12px] sm:block hidden ">U.S. Equities</h1>
             ...
             <h1 className="text-[#9CA3AF]  font-semibold text-[12px] sm:block hidden ">Crypto</h1>
             <div className="flex my-[16px]">
